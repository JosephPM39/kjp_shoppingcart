...
class ObjectUtilsTest {
    ...
    @BeforeEach
    void setUp() {
        completeTokenDTO = TokenDTO.builder()
                ...
                .build();
        incompleteTokenDTO = TokenDTO.builder()
                .tokenType("new_token_type")
                .expiresIn(800)
                .build();

        completeTypesMock = TypesMock.builder()
                ...
                .String("Hello World")
                .build();
        incompleteTypesMock = TypesMock.builder()
                .String("By world")
    ...
    void getInstanceWithNotNullFields() {
        TokenDTO finalToken = ObjectUtils.getInstanceWithNotNullFields(incompleteTokenDTO, completeTokenDTO, TokenDTO.class);
        ...
        TypesMock finalTypesMock = ObjectUtils.getInstanceWithNotNullFields(incompleteTypesMock, completeTypesMock, TypesMock.class);
