...
public class ProductServiceUtils {
  public static void throwIfProductNotFound(UUID productId, IProductRepository productRepository) {
    ...
    throw new ResourceNotFoundException(
        "The product with the Id:".concat(productId.toString()).concat(" not found"));
  }

  public static void throwIfSomeProductNotFound(
      List<UUID> productIdList, IProductRepository productRepository) {
